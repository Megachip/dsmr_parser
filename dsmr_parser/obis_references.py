...
# D0 Protokol
PHASE_ANGLE_UL2_UL1 = r'^\d-\d:81\.7\.1.+?\r\n'
PHASE_ANGLE_UL3_UL1 = r'^\d-\d:81\.7\.2.+?\r\n'
PHASE_ANGLE_IL1_UL1 = r'^\d-\d:81\.7\.4.+?\r\n'
PHASE_ANGLE_IL2_UL2 = r'^\d-\d:81\.7\.15.+?\r\n'
PHASE_ANGLE_IL3_UL3 = r'^\d-\d:81\.7\.26.+?\r\n'
FREQUENCY = r'^\d-\d:14\.7\.0.+?\r\n'
HISTORICAL_ENERGY_1D = r'^\d-\d:1\.8\.0\*96.+?\r\n'
HISTORICAL_ENERGY_7D = r'^\d-\d:1\.8\.0\*97.+?\r\n'
HISTORICAL_ENERGY_30D = r'^\d-\d:1\.8\.0\*98.+?\r\n'
HISTORICAL_ENERGY_365D = r'^\d-\d:1\.8\.0\*99.+?\r\n'
HISTORICAL_ENERGY_SINCE_RESET = r'^\d-\d:1\.8\.0\*100.+?\r\n'
FIRMWARE_INFO = r'^\d-\d:0\.2\.0\*255.+?\r\n'
PARAMETER_CRC = r'^\d-\d:96\.90\.2\*255.+?\r\n'
DEVICE_ERROR_STATUS = r'^\d-\d:97\.97\.0\*255.+?\r\n'

# D0 Groups
PHASE_ANGLE_MEASUREMENTS = (
    PHASE_ANGLE_UL2_UL1,
    PHASE_ANGLE_UL3_UL1,
    PHASE_ANGLE_IL1_UL1,
    PHASE_ANGLE_IL2_UL2,
...
HISTORICAL_ENERGY_MEASUREMENTS = (
    HISTORICAL_ENERGY_1D,
    HISTORICAL_ENERGY_7D,
    HISTORICAL_ENERGY_30D,
    HISTORICAL_ENERGY_365D,
    HISTORICAL_ENERGY_SINCE_RESET
)
